      ...
      <div class="footer-grid">
        ...
        <div class="col-links">
          ...
          <ul class="footer-list">
            <li><router-link :to="{path: '/', query: {menuId: 'COM_01'}}" class="link">회사소개</router-link></li>
            <li><router-link :to="{path: '/', query: {menuId: 'COM_02'}}" class="link">CEO 인사말</router-link></li>
            <li><router-link :to="{path: '/', query: {menuId: 'COM_05'}}" class="link">오시는 길</router-link></li>
          </ul>
        </div>
        ...
        <div class="col-links">
          ...
          <ul class="footer-list">
            <li><router-link :to="{path: '/', query: {menuId: 'BUS_01'}}" class="link">SI/SM 사업</router-link></li>
            <li><router-link :to="{path: '/', query: {menuId: 'SOL_01'}}" class="link">AI 솔루션</router-link></li>
            <li><router-link :to="{path: '/', query: {menuId: 'SOL_02'}}" class="link">스마트팜</router-link></li>
          </ul>
        </div>
