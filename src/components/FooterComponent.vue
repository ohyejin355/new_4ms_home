      ...
      <div class="footer-grid">
        ...
        <div class="col-links">
          ...
          <ul class="footer-list">
            <li><router-link :to="{path: '/company', query: {menuId: 'company_info'}}" class="link">회사소개</router-link></li>
            <li><router-link :to="{path: '/company', query: {menuId: 'company_ceo'}}" class="link">CEO 인사말</router-link></li>
            <li><router-link :to="{path: '/company', query: {menuId: 'company_map'}}" class="link">오시는 길</router-link></li>
          </ul>
        </div>
